...
public class DownReportTask extends RunTask {
    private static final String TAG = "DownReportTask";
    ...
    public DownReportTask(Context context, String fromFlag, String topicId, String appName, String pkgName, String appId, int verCode) {
        mContext = context;
    ...
    protected void run() {
        ...
        MarketDebug.recordReportTimeLog("report downloaded apk: " + mAppName, result, startTimeMillis, endTimeMillis, count);
    }


    public boolean reportDownloadResult() {
        String content = null;
        try {
            String reqContent = getReportDownReqContent();
        ...
        Util.log(TAG, "reportDownloadResult", "responce content:" + content);
        try {
    ...
    private String getReportDownReqContent() {
        ...
        try {
            ...
            headerObject.put("mcd", MessageCode.GET_DATA_DOWNLOAD_REQ);
        ...
        try {
            ...
            appJA.put(appInfoJo);
            jsonObjBody.put("downInfo", appJA);
