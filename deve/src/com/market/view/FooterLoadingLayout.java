...
public class FooterLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        mProgressBar = (ProgressBar) findViewById(R.id.listview_loading);
        mHintView = (TextView) findViewById(R.id.listview_loading_text);
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.layout_app_detail_comment_loading, null);
        return container;
    }
    ...
    public int getContentSize() {
        View view = findViewById(R.id.layout_loading);
        if (null != view) {
