...
public abstract class DownloadTabBaseActivity extends FragmentActivity {
    public static final String TAG = "downBaseActivity";

    private IDownloadService mDownloadService;
    private final int REQUEST_CODE = 300;
    private final int RESULT_CODE = 100;
    private ExitMarketDialog dialog;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        dialog = new ExitMarketDialog(DownloadTabBaseActivity.this, R.style.MyMarketDialog);
    }
