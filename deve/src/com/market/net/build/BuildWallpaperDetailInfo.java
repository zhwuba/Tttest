...
import com.market.net.request.GetWallpaperDetailReq;

public class BuildWallpaperDetailInfo implements DataBuilder
{
    @Override
    public String buildToJson(Context context,int msgCode,Object obj)
    {
        ...
        GetWallpaperDetailReq listReq = (GetWallpaperDetailReq)obj;
