...
public class CategoryThemesAdapter extends BaseAdapter{

    private Context mContext;
    ArrayList<Map<String, Object>> list;
    private int mImageWidth;
    private int mImageHeight;
    public CategoryThemesAdapter(Context context,ArrayList<Map<String, Object>> listData){
        mContext=context;
        list=listData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if(convertView==null){
            convertView=LayoutInflater.from(mContext).inflate(R.layout.gridview_category_theme, null);
