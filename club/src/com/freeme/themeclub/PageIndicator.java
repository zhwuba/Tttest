...
public class PageIndicator extends LinearLayout {
    ...
    public PageIndicator(Context context, AttributeSet attrs) {
        ...
        layoutParams = new LayoutParams(getResources().getDimensionPixelSize(
                R.dimen.indicator_width), getResources().getDimensionPixelSize(
                R.dimen.indicator_hight));
        ...
        layoutParams.rightMargin = getResources().getDimensionPixelSize(
                R.dimen.indicator_margin);
        //*/
        mNormalDrawable = this.getResources().getDrawable(
