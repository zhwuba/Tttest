 ...
 */
package com.freeme.themeclub.fillableloaders.attributes;
...
import com.freeme.themeclub.fillableloaders.clippingtransforms.TransformAbstractFactory;
import com.freeme.themeclub.fillableloaders.clippingtransforms.TransformFactoryImpl;
...
public class AttributeExtractorImpl implements AttributeExtractor {
    ...
    private TypedArray attributeArray() {
        if (weakAttributeArray == null) {
            weakAttributeArray = new WeakReference<TypedArray>(context().getTheme()
